    ...
    <?php if (!$role): ?>
      ...
      <div class="auth-card">
        ...
        <div class="role-select-grid">
          <a href="/register/supermarket" class="role-select-card">
          ...
          <a href="/register/charity" class="role-select-card">
            <div class="role-select-icon">
          ...
          <a href="/register/consumer" class="role-select-card">
            <div class="role-select-icon">
      ...
      <p class="auth-switch">Already have an account? <a href="/login" class="text-primary font-semibold">Sign in</a></p>
    ...
    <?php else: ?>
      ...
      <div class="register-shell">
        ...
        <div class="register-panel-right">
          ...
          <div class="role-tabs">
            <a href="/register/consumer"   class="role-tab <?= $role === 'consumer'   ? 'active' : '' ?>">Consumer</a>
            <a href="/register/charity"    class="role-tab <?= $role === 'charity'    ? 'active' : '' ?>">Charity</a>
            <a href="/register/supermarket" class="role-tab <?= $role === 'supermarket' ? 'active' : '' ?>">Supermarket</a>
          </div>
          ...
          <form action="/register" method="post" novalidate>
            ...
            <p class="auth-switch mt-4">Already have an organization account? <a href="/login" class="text-primary font-semibold">Log In</a></p>
          </form>
        </div>
      </div>
